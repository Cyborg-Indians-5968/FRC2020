...
public class AutoNavBarrel implements IRobotMode {
    ...
    public void driveStraightShort() { // Step 2
        drive.driveDistance(30, speed, 180, () -> driveStraightShort1());
    }
    ...
    private void driveStraightShort2() { // Step 4
        drive.driveDistance(30, speed, 0, () -> driveStraightLong1());
    }
    ...
    private void driveStraightShort3() { // Step 6
        drive.driveDistance(60, speed, 0, () -> driveStraightShort4());
    }
    ...
    private void driveStraightLong2() { // Step 8
        drive.driveDistance(90, speed, 180, () -> driveStraightLong3());
    }
    ...
    private void driveStraightShort5() { // Step 10
        drive.driveDistance(30, speed, 0, () -> driveStraightLong4());
    }

    private void driveStraightLong4() { // Step 11
        drive.driveDistance(315, speed, -90, null);
    }
