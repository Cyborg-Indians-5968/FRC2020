...
public class AutoNavBounce implements IRobotMode {
    ...
    public void driveStraightLong() { // Step 2
        drive.driveDistance(120, speed, 72, () -> driveStraightShort());
    }

    public void driveStraightShort() { // Step 3
        drive.driveDistance(12, speed, 0, () -> driveStraightLong1());
    }

    public void driveStraightLong1() { // Step 4
        drive.driveDistance(106, speed, -90, () -> driveStraightLong2());
    }

    public void driveStraightLong2() { // Step 5
        drive.driveDistance(106, speed, 90, () -> driveStraightShort1());
    }

    public void driveStraightShort1() { // Step 6
        drive.driveDistance(40, speed, 0, () -> driveStraightShort3());
    }

    public void driveStraightShort3() { // Step 7
        drive.driveDistance(67, speed, -80, () -> driveStraightEnd());
    }

    public void driveStraightEnd() { // Step 8
        drive.driveDistance(35, speed, 45, null);
    }
