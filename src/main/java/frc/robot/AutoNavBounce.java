...
public class AutoNavBounce implements IRobotMode {
    ...
    public void driveStraightLong() { // Step 2
        drive.driveDistance(120, speed, 18, () -> driveStraightShort());
    }
    ...
    public void driveStraightLong1() { // Step 4
        drive.driveDistance(106, speed, 5, () -> driveStraightLong2());
    }

    public void driveStraightLong2() { // Step 5
        drive.driveDistance(106, speed, -5, () -> driveStraightShort1());
    }

    public void driveStraightShort1() { // Step 6
        drive.driveDistance(40, speed, 5, () -> driveStraightShort3());
    }

    public void driveStraightShort3() { // Step 7
        drive.driveDistance(67, speed, 45, () -> driveStraightEnd());
    }
